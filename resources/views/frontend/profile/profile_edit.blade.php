        ...
        <div class="row justify-content-center">
            <div class="col col-12">
                <div class="container px-5 py-3">
                    <div class="row">
                        <h4 class="fs-3 text-start pt-3">Edit Profile</h4>
                            ...
                            <form action="{{ route('profile_update', $show->name) }}" method="post"
                                ...
                                <div class="mb-3">
                                    ...
                                    <input class="form-control form-control-md" type="text"
                                        aria-label=".form-control-lg example" name="name" value="{{ $show->name }}">
                                </div>

                                <div class="mb-3">
                                    <label class="form-label">NIM</label>
                                    <input class="form-control form-control-md" type="text"
                                        aria-label=".form-control-lg example" name="nim" value="{{ $show->nim }}">
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input class="form-control form-control-md" type="text"
                                        aria-label=".form-control-lg example" name="skill" value="{{ $show->skill }}">
                                </div>

                                <div class="mb-3">
                                    <label class="form-label">Email</label>
                                    <input class="form-control form-control-md" type="email"
                                        aria-label=".form-control-lg example" name="email" value="{{ $show->email }}">
                                </div>

                                <div class="mb-3">
                                    <label class="form-label">No HP</label>
                                    <input class="form-control form-control-md" type="text"
                                        aria-label=".form-control-lg example" name="hp" value="{{ $show->hp }}">
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input class="form-control form-control-md" type="text"
                                        aria-label=".form-control-lg example" name="twitter" value="{{ $show->twitter }}">
                                </div>
                                        ...
                                        <div class="form-check-info">
                                            <label class="form-check-label">
                                                <input type="radio" class="form-check-input" name="status"
                                                    id="Bekerja" value="Bekerja"
                                                    {{ $show->status == 'Bekerja' ? 'checked' : '' }}> Bekerja
                                            </label>
                                        </div>
                                        <div class="form-check-info">
                                            <!-- Sesuaikan nilai margin sesuai kebutuhan -->
                                            <label class="form-check-label">
                                                <input type="radio" class="form-check-input" name="status"
                                                    id="Tidak Bekerja" value="Tidak Bekerja"
                                                    {{ $show->status == 'Tidak Bekerja' ? 'checked' : '' }}>
                                                Tidak Bekerja
                                            </label>
                                        </div>
                                    </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input class="form-control form-control-md" type="text"
                                        aria-label=".form-control-lg example" name="place"
                                        value="{{ $show->place }}">
                                </div>
