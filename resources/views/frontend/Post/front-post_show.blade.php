    ...
    <div class="container">
        <div class="row">
            <div class="col col-12">
                <h4 class="card-title fs-4 fw-bold text-start pt-3">My Media</h4>
            </div>
                    ...
                    <div class="col col-12 col-md-6 col-lg-3 mt-5" data-aos="fade-up" data-aos-duration="1200">
                        <div class="card-custom shadow rounded-3 mx-auto">
                            ...
                            <div class="deskripsi">
                                ...
                                <a href="{{ route('detail', [$item->slug]) }}" class="btn btn-primary btn-sm mt-3"><i
                                        class="bi bi-eye-fill"></i></a>
                                <a href="{{ route('post_edit', $item->slug) }}"
                                    class="btn btn-warning text-light btn-sm mt-3"><i class="bi bi-pencil-square"></i></a>
                                <a href="{{ route('post_delete', $item->slug) }}"
                                    onclick="return confirm('data akan dihapus')" class="btn btn-danger btn-sm mt-3"><i
