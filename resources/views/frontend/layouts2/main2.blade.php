...
<body>
    ...
    @if (Request::is('posts/create/*') ||
            ...
            $page == 'invoice' ||
            Request::is('like/*'))
        <div class="bg-user" style="max-height: 420px;">
            <div class="container-fluid">
                <div class="row">
                    <div class="col col-12 col-lg-3 container">
                        @include('frontend.partials.user')

                    </div>
                    <div class="col col-12 col-lg-9 mt-5">
                        <div class="card container shadow rounded-5" style="min-height: 500px">
                            <div class="card-body">
                                @yield('container')
                            </div>
                        </div>
